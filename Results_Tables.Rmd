...
pwpTtestTable |>
  ...
  labels = c("UPDRS-III", "FGA", "10-m Gait Speed", 'PDQ-39', 'PROMIS-29','GDS','GAD-7','MoCA', 'BRS', 'RDAS', 'HRV')),
...
cpTtestTable|>
  ...
  labels = c('PROMIS-29','GDS','GAD-7','MoCA', 'BRS', 'RDAS', 'HRV')),
  Dimension = factor(dimension, levels = c(
    'Active Coping',
  'Use of Informational Support' ,
  'Positive Reframing' ,
...
interpret_promis |>
  ...
  ggplot2::labs(
    x = "Difference in T-Score from PreTest to PostTest",
    y = '', 
    title = 'Change in PROMIS Dimension Tscores from PreTest to PostTest')
...
hrv24hr |>
  ...
  ggplot2::geom_vline(xintercept = 0)+
  ggplot2::labs(
    x = "Difference from PreTest to PostTest",
    y = '', 
    title = 'Change in Heart Rate Variability Variables from PreTest to PostTest')+
